...
{
    public class BuoyantPlayer : MonoBehaviour
    {
        ...
        public float waterLevelOffset = -0.9f;
        ...
        public Vector3 playerOffset = new Vector3(0, -0.9f, 0);
        ...
        private void Update()
        {
            ...
            switch (_buoyancyType)
            {
                case BuoyancyType.NonPhysical:
                {
                    var t = transform;
                    var vec  = t.position;
                    vec.y = Heights[0].y + waterLevelOffset + playerOffset.y;
                    t.position = vec;
